    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex items-center gap-4">
                ...
                <form method="POST" action="/logout">
                    @csrf
                    <button class="px-6 py-2 bg-[#8FABD4] dark:bg-blue-600 text-white rounded-lg font-semibold hover:bg-[#7a9bc7] dark:hover:bg-blue-700 transition-colors duration-300 cursor-pointer">
                        Logout
                    </button>
                </form>
            </div>
        ...
        <div id="mobile-menu" class="hidden md:hidden pb-4 space-y-2 bg-white dark:bg-gray-900 rounded-lg mt-2 shadow-lg transition-all duration-300 ease-in-out">
            ...
            <div class="pt-2 border-t border-gray-200 dark:border-gray-700">
                @guest
                <a href="{{ route('login') }}" class="block px-4 py-3 text-center bg-[#0C2B4E] dark:bg-blue-600 text-white rounded-lg font-semibold hover:bg-[#7a9bc7] dark:hover:bg-blue-700 transition-colors duration-300">
                    Sign In
                </a>
                ...
                @if(auth()->user()->role === 'admin')
                <a href="{{ route('dashboard') }}" class="block px-4 py-3 text-center hover:bg-[#7a9bc7] dark:hover:bg-blue-700 text-white rounded-lg font-semibold bg-[#8FABD4] dark:bg-blue-600 transition-colors duration-300 mb-2">
                    Dashboard
                </a>
                @endif
